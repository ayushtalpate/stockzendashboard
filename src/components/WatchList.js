...
const labels=watchlist.map((suArray) => suArray['name']);
    ...
    <span className="actions">
      <span>
        ...
        <Tooltip title="Analytics (A)"
          ...
          arrow
          TransitionComponent={Grow}>
          <button className="action"><BarChartOutlined className="iocn"/></button>
        </Tooltip>
        <Tooltip title="More (M)" placment="top" arrow TransitionComponent={Grow}>
          <button className="More">
          <MoreHoriz className="iocn"/>
          </button>
        </Tooltip>
